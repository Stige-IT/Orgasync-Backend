...
class EmployeeCompanyProject(Base):
    ...
    id_employee = Column(String(100), ForeignKey("employee.id", ondelete="CASCADE"))
    employee = relationship("Employee")
    id_company_project = Column(
        String(100), ForeignKey("company_project.id", ondelete="CASCADE")
    )
